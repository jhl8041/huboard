package com.humuson.huboard.service.classifier;

import com.humuson.huboard.ApplicationProperties;
import com.humuson.huboard.model.Recognition;
import com.humuson.huboard.util.GraphBuilder;
import com.humuson.huboard.util.IOUtil;
import com.humuson.huboard.util.ImageUtil;
import com.humuson.huboard.util.ServiceException;
...
public class ObjectDetector {
    ...
    public ObjectDetector(final ApplicationProperties applicationProperties) {
        ...
        try {
        	GRAPH_DEF = IOUtil.readAllBytesOrExit("C:\\Users\\humuson\\Desktop\\humusOn Workspace\\huboard\\src\\main\\resources\\static\\YOLO\\yolo-voc.pb");
        	LABELS = IOUtil.readAllLinesOrExit("C:\\Users\\humuson\\Desktop\\humusOn Workspace\\huboard\\src\\main\\resources\\static\\YOLO\\yolo-voc-labels.txt");
